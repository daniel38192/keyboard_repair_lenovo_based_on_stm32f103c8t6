...
static struct keyboard_button keyboard_map[KEYBOARD_MATRIX_ROWS][KEYBOARD_MATRIX_COLS] = {
    ...
    //Row 2
    {{KEY, HID_KEY_KP_COMMA_DOT}, {KEY, HID_KEY_KP_3}, {EMPTY, 0}, {EMPTY, 0}, {KEY, HID_KEY_N}, {EMPTY, 0}, {EMPTY, 0}, {KEY, HID_KEY_B}, {EMPTY, 0}, {KEY, HID_KEY_SLASH}, {EMPTY, 0}, {EMPTY, 0}, {MODIFIER, HID_MODIFIER_RIGHT_ALT}, {KEY, HID_KEY_RIGHT_ARROW}, {KEY, HID_KEY_LEFT_ARROW}, {KEY, HID_KEY_DOWN_ARROW}, {KEY, HID_KEY_SPACE}, {EMPTY, 0} },
    //Row 3
    ...
    //Row 8
    {{KEY, HID_KEY_KP_SLASH}, {KEY, HID_KEY_KP_7}, {EMPTY, 0}, {KEY, HID_KEY_ESCAPE}, {KEY, HID_KEY_H}, {KEY, HID_KEY_F4}, {KEY, HID_KEY_NON_US_HASH2}, {KEY, HID_KEY_G},{EMPTY, 0},{KEY, HID_KEY_QUOTE}, {KEY, HID_KEY_F6}, {EMPTY, 0}, {MODIFIER, HID_MODIFIER_LEFT_ALT}, {EMPTY, 0}, {KEY, HID_KEY_UP_ARROW}, {EMPTY, 0},  {KEY, HID_KEY_F5}, {EMPTY, 0}},
};
